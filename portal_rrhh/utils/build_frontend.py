"""
Script para compilar el frontend y actualizar las referencias en el HTML
Se ejecuta automáticamente durante bench build cuando se ejecuta yarn build desde la raíz
"""
...
def update_html_references():
	...
	Se ejecuta automáticamente desde package.json después de yarn build
	"""
	# Obtener rutas relativas al directorio de la app
	current_dir = os.path.dirname(os.path.abspath(__file__))
	app_dir = os.path.dirname(os.path.dirname(current_dir))
	portal_dir = os.path.join(app_dir, "portal_rrhh")
...
def build_frontend():
	"""
	Compila el frontend Vue.js y actualiza las referencias en portal_rrhh.html
	Este hook se ejecuta automáticamente durante bench build
	"""
	# Obtener rutas relativas al directorio de la app
	current_dir = os.path.dirname(os.path.abspath(__file__))
	app_dir = os.path.dirname(os.path.dirname(current_dir))
	...
	print("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	print("📦 Compilando frontend Vue.js de portal_rrhh...")
	print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
	...
	try:
		...
		print(f"❌ Error al compilar frontend:")
		if e.stdout:
			print(e.stdout)
		if e.stderr:
			print(e.stderr)
